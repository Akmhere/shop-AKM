...
//Product.find({} , ) object is empty means no condition
// (err,docs) in place of docs u csn write anything
...
//when ever we are not writing the callback func we should use the async await
router.post("/addreview", async (req, res) => {
  ...
  //now we have to calculate the average review for the product and update it
  var rating =
